...
class KITTI_Raw_KittiSplit_Full(MODD2_Raw):
    def __init__(self,
                 args,
                 root,
                 flip_augmentations=True,
...
class KITTI_Raw_EigenSplit_Train(MODD2_Raw):
    def __init__(self,
                 args,
                 root,
                 flip_augmentations=True,
...
class KITTI_Raw_EigenSplit_Valid(MODD2_Raw):
    def __init__(self,
                 args,
                 root,
                 flip_augmentations=False,
...
class KITTI_Raw_EigenSplit_Full(MODD2_Raw):
    def __init__(self,
                 args,
                 root,
                 flip_augmentations=True,
